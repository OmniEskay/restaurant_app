...
def view_orders():
    ...
    for o in orders:
        if o.menu_item:  
            table.append([o.id, o.customer_name, o.menu_item.name, o.menu_item.price])
        else:
            table.append([o.id, o.customer_name, "Menu Item Not Found", "N/A"])
    print("\n📦 Orders:")
    print(tabulate(table, headers=["ID", "Customer", "Item", "Price"], tablefmt="grid"))
